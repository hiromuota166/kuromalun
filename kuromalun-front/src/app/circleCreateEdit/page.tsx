...
const page = () => {
  return (
    <div className=' md:flex h-[calc(100vh+10vh)] md:h-auto'>
      {/* サークル名 */}
      ...
      {/* 内容 */}
      <div className='bg-mainColor md:w-1/2 m-4 md:100vh h-120vh'>
        ...
        <div className='p-2 m-2 border-zinc-600 border rounded-xl'>
